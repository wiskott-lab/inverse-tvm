...
if __name__ == '__main__':
    ...
    init_bb_id, init_enc_id, init_dec_id, init_detect_id = None, None, None, None
    ...
    if run_id:
        ...
        bb_to_img = init_submodules(params=run_params, run_ids=bb_ids, modules=bb_modules)
        ...
        enc_to_img = init_submodules(params=run_params, run_ids=enc_ids, modules=enc_modules)
        ...
        dec_to_img = init_submodules(params=run_params, run_ids=dec_ids, modules=dec_modules)
        ...
        detr_out_to_img = init_submodules(params=run_params, modules=detect_modules, run_ids=detect_ids)
