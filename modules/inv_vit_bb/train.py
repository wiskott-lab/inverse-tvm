...
if __name__ == '__main__':
    ...
    if run_id:
        ...
        inv_bb, inv_bb_optim = nu.init_from_checkpoint(checkpoint, inv_vit_bb_module, neptune_params)
        ...
        inv_bb = nu.init_model_from_params(module=inv_vit_bb_module, params=neptune_params)
