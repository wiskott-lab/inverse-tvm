...
from modules.inv_vit.inv_enc.utils import test_inv_enc
from modules.inv_vit.inv_enc import models as inv_vit_enc_module
...
if __name__ == '__main__':
    ...
    if run_id:
        ...
        inv_enc, inv_enc_optim = nu.init_from_checkpoint(checkpoint, inv_vit_enc_module, run_params)
        ...
        inv_enc = nu.init_model_from_params(module=inv_vit_enc_module, params=run_params)
